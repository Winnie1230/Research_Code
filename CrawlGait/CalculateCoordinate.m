% reference values
%[Ax,Ay,Bx,By,Cx,Cy,Dx,Dy,Ex,Ey,Fx,Fy,Gx,Gy,l4] = calculate_coordinate(130,0.5*130,130,0.6*130,126,18,56,160);

% Calculate coordinate of every point
function [A,B,C,D,E,F,G] = CalculateCoordinate(R,l1,l2,l3,l4,l5,l6,l7,l8,theta_deg,up_deg,theta0_deg)
    theta = theta_deg*pi/180; % convert deg to rad

    % ----- the coordinate of point A,B,D,E -----
    Ax = l1*sin(theta);
    Ay = l1*cos(theta);
    Bx = R*sin(theta);
    By = R*cos(theta);
