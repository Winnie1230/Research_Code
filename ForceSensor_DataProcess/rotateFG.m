...
%% read data
% data = readmatrix('output_63.xlsx');
% data = readmatrix('output_63_transflag.xlsx');
% data = readmatrix('output_63_bump.xlsx');
% data = readmatrix('output_63_l.xlsx');
% data = readmatrix('output_63_r.xlsx');

temp = data(:,end-2:end)';
correct_Fz_r = (R_r*data(:,end-5:end-3)')';
% correct_Fz_l = (R_l*Rts*data(:,end-2:end)')';
correct_Fz_l = (R_l*data(end,end-2:end)')';
