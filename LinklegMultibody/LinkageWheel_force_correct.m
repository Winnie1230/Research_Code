...
O.theta = 0 ;
O.q = [cos(O.theta/2) 0 0 sin(O.theta/2)]'; % Orientation of mass O (quaternion)
O.m = 1000; % Mass
...
for theta = 63 %17:0.1:160
    ...
    G_Force = [0 0 400]'*1e6;
    if (length(find(G_Force)))
        G_e1G = Rq(s(67:70,k))*config(:,2, 9);
        G_e2G = Rq(s(74:77,k))*config(:,2,10);
        wrench.ext(55:57,k) =  (G_Force'*G_e2G / (G_Force'*G_e1G + G_Force'*G_e2G)) * [G_Force(1) 0 G_Force(3)]' + [0 0.5*G_Force(2) 0]';
        wrench.ext(58:60,k) = skew(G_e1G)*wrench.ext(55:57,k);
        wrench.ext(61:63,k) =  (G_Force'*G_e1G / (G_Force'*G_e1G + G_Force'*G_e2G)) * [G_Force(1) 0 G_Force(3)]' + [0 0.5*G_Force(2) 0]';
...
%% Friction Wrench
    ...
    %% Correction 
    wrench.total_ = zeros(6*n,1);
    for j = 0 : n-1
        wrench.total_(6*j+1:6*j+6,k) = [ Rq(s( 7*j+4: 7*j+7,k))' zeros(3,3) ; zeros(3,3) Rq(s( 7*j+4: 7*j+7,k))' ] * wrench.total(6*j+1:6*j+6,k); 
    end
    
    % O
    wrench.total_( 4:6,k) = wrench.total_( 4:6,k);
    F_O1_O(2,theta_index)  = wrench.total_( 2,k);
    F_O1_O(4,theta_index)  = wrench.total_( 4,k);
    F_O1_O(6,theta_index)  = wrench.total_( 6,k);
    F_O2_O(2,theta_index)  = wrench.total_( 2,k);
    F_O2_O(4,theta_index)  = wrench.total_( 4,k);
    F_O2_O(6,theta_index)  = wrench.total_( 6,k);
    F_O1_O(5,theta_index)  = 0;
    F_O2_O(5,theta_index)  = 0;
    % a1
    F_O1_a1(2,theta_index) = wrench.total_( 8,k);
    F_O1_a1(4,theta_index) = wrench.total_(10,k);
    F_O1_a1(6,theta_index) = wrench.total_(12,k);
    F_A1_a1(2,theta_index) = wrench.total_( 8,k);
    F_A1_a1(4,theta_index) = wrench.total_(10,k);
    F_A1_a1(6,theta_index) = wrench.total_(12,k);
    F_B1_a1(2,theta_index) = wrench.total_( 8,k);
    F_B1_a1(4,theta_index) = wrench.total_(10,k);
    F_B1_a1(6,theta_index) = wrench.total_(12,k);
    F_O1_a1(5,theta_index)  = 0;
    F_A1_a1(5,theta_index)  = 0;
    F_B1_a1(5,theta_index)  = 0;
    % a2
    F_O2_a2(2,theta_index) = wrench.total_(14,k);
    F_O2_a2(4,theta_index) = wrench.total_(16,k);
    F_O2_a2(6,theta_index) = wrench.total_(18,k);
    F_A2_a2(2,theta_index) = wrench.total_(14,k);
    F_A2_a2(4,theta_index) = wrench.total_(16,k);
    F_A2_a2(6,theta_index) = wrench.total_(18,k);
    F_B2_a2(2,theta_index) = wrench.total_(14,k);
    F_B2_a2(4,theta_index) = wrench.total_(16,k);
    F_B2_a2(6,theta_index) = wrench.total_(18,k);
    F_O2_a2(5,theta_index)  = 0;
    F_A2_a2(5,theta_index)  = 0;
    F_B2_a2(5,theta_index)  = 0;
    % b1
    F_B1_b1(2,theta_index) = wrench.total_(20,k);
    F_B1_b1(4,theta_index) = wrench.total_(22,k);
    F_B1_b1(6,theta_index) = wrench.total_(24,k);
    F_C1_b1(2,theta_index) = wrench.total_(20,k);
    F_C1_b1(4,theta_index) = wrench.total_(22,k);
    F_C1_b1(6,theta_index) = wrench.total_(24,k);
    F_F1_b1(2,theta_index) = wrench.total_(20,k);
    F_F1_b1(4,theta_index) = wrench.total_(22,k);
    F_F1_b1(6,theta_index) = wrench.total_(24,k);
    F_B1_b1(5,theta_index) = 0;
    F_C1_b1(5,theta_index) = 0;
    F_F1_b1(5,theta_index) = 0;
    % b2
    F_B2_b2(2,theta_index) = wrench.total_(26,k);
    F_B2_b2(4,theta_index) = wrench.total_(28,k);
    F_B2_b2(6,theta_index) = wrench.total_(30,k);
    F_C2_b2(2,theta_index) = wrench.total_(26,k);
    F_C2_b2(4,theta_index) = wrench.total_(28,k);
    F_C2_b2(6,theta_index) = wrench.total_(30,k);
    F_F2_b2(2,theta_index) = wrench.total_(26,k);
    F_F2_b2(4,theta_index) = wrench.total_(28,k);
    F_F2_b2(6,theta_index) = wrench.total_(30,k);
    F_B2_b2(5,theta_index) = 0;
    F_C2_b2(5,theta_index) = 0;
    F_F2_b2(5,theta_index) = 0;
    % g1
    F_A1_g1(2,theta_index) = wrench.total_(32,k);
    F_A1_g1(4,theta_index) = wrench.total_(34,k);
    F_A1_g1(6,theta_index) = wrench.total_(36,k);
    F_D1_g1(2,theta_index) = wrench.total_(32,k);
    F_D1_g1(4,theta_index) = wrench.total_(34,k);
    F_D1_g1(6,theta_index) = wrench.total_(36,k);
    F_E_g1(2,theta_index)  = wrench.total_(32,k);
    F_E_g1(4,theta_index)  = wrench.total_(34,k);
    F_E_g1(6,theta_index)  = wrench.total_(36,k);
    F_A1_g1(5,theta_index) = 0;
    F_D1_g1(5,theta_index) = 0;
    F_E_g1(5,theta_index)  = 0;
    % g2
    F_A2_g2(2,theta_index) = wrench.total_(38,k);
    F_A2_g2(4,theta_index) = wrench.total_(40,k);
    F_A2_g2(6,theta_index) = wrench.total_(42,k);
    F_D2_g2(2,theta_index) = wrench.total_(38,k);
    F_D2_g2(4,theta_index) = wrench.total_(40,k);
    F_D2_g2(6,theta_index) = wrench.total_(42,k);
    F_E_g2(2,theta_index)  = wrench.total_(38,k);
    F_E_g2(4,theta_index)  = wrench.total_(40,k);
    F_E_g2(6,theta_index)  = wrench.total_(42,k);
    F_A2_g2(5,theta_index) = 0;
    F_D2_g2(5,theta_index) = 0;
    F_E_g2(5,theta_index)  = 0;
    % d1
    F_D1_d1(2,theta_index) = wrench.total_(44,k);
    F_D1_d1(4,theta_index) = wrench.total_(46,k);
    F_D1_d1(6,theta_index) = wrench.total_(48,k);
    F_C1_d1(2,theta_index) = wrench.total_(44,k);
    F_C1_d1(4,theta_index) = wrench.total_(46,k);
    F_C1_d1(6,theta_index) = wrench.total_(48,k);
    F_D1_d1(5,theta_index) = 0;
    F_C1_d1(5,theta_index) = 0;
    % d2
    F_D2_d2(2,theta_index) = wrench.total_(50,k);
    F_D2_d2(4,theta_index) = wrench.total_(52,k);
    F_D2_d2(6,theta_index) = wrench.total_(54,k);
    F_C2_d2(2,theta_index) = wrench.total_(50,k);
    F_C2_d2(4,theta_index) = wrench.total_(52,k);
    F_C2_d2(6,theta_index) = wrench.total_(54,k);
    F_D2_d2(5,theta_index) = 0;
    F_C2_d2(5,theta_index) = 0;
    % e1
    F_G_e1(2,theta_index)  = wrench.total_(56,k);
    F_G_e1(4,theta_index)  = wrench.total_(58,k);
    F_G_e1(6,theta_index)  = wrench.total_(60,k);
    F_F1_e1(2,theta_index) = wrench.total_(56,k);
    F_F1_e1(4,theta_index) = wrench.total_(58,k);
    F_F1_e1(6,theta_index) = wrench.total_(60,k);
    F_G_e1 (5,theta_index) = 0;
    F_F1_e1(5,theta_index) = 0;
    % e2
    F_G_e2(2,theta_index)  = wrench.total_(62,k);
    F_G_e2(4,theta_index)  = wrench.total_(64,k);
    F_G_e2(6,theta_index)  = wrench.total_(66,k);
    F_F2_e2(2,theta_index) = wrench.total_(62,k);
    F_F2_e2(4,theta_index) = wrench.total_(64,k);
    F_F2_e2(6,theta_index) = wrench.total_(66,k);
    F_G_e2 (5,theta_index) = 0;
    F_F2_e2(5,theta_index) = 0;
