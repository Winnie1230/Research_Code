...
ng_fix = 2; % fix pointG to the ground(= regard pointG as Hinge Joint or Ball-And-Socket Joint?)
...
for t = 1:time.step
    ...
    Jbs_G_e1 = [  eye(3)  -skew(vector.epsilon1_G)];
    Jbs_G_e2 = [  eye(3)  -skew(vector.epsilon2_G)];
...
%         Js_BASE         X         X        X        X         X        X         X        X         X         X; 
              z         z         z        z        z         z        z         z        z  Jbs_G_e1         z;
              z         z         z        z        z         z        z         z        z         z  Jbs_G_e2];       
...
%     arrow3d([s(71,1) s(71,1)+vector.epsilon2_G(1)],[s(72,1) s(72,1)+vector.epsilon2_G(2)],[s(73,1) s(73,1)+vector.epsilon2_G(3)],a,b,c,'r');
   ...
   % plot forces
    scale = 1e-5;
    arrow3d([s(64,1)+vector.epsilon1_G(1) s(64,1)+vector.epsilon1_G(1)+scale*Fbs_G_e1(1)],[s(65,1)+vector.epsilon1_G(2) s(65,1)+vector.epsilon1_G(2)+scale*Fbs_G_e1(2)],[s(66,1)+vector.epsilon1_G(3) s(65,1)+vector.epsilon1_G(3)+scale*Fbs_G_e1(3)],a,b,c,'k');
    arrow3d([s(71,1)+vector.epsilon2_G(1) s(71,1)+vector.epsilon2_G(1)+scale*Fbs_G_e2(1)],[s(72,1)+vector.epsilon2_G(2) s(72,1)+vector.epsilon2_G(2)+scale*Fbs_G_e2(2)],[s(73,1)+vector.epsilon2_G(3) s(73,1)+vector.epsilon2_G(3)+scale*Fbs_G_e2(3)],a,b,c,'k');
